...
# 페이지 설정
st.set_page_config(page_title="날씨 확인하고 출발하세요", page_icon="🚗", layout="wide")
...
# 위치 정보 가져오기 (중복 키 에러 방지를 위해 고유 key 추가)
loc = get_geolocation(key='daily_route_location')
